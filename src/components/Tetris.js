...
function Tetris () {
    ...
    const drop = () => {
        ...
        if (Math.max(...boxArr.map((e) => e.length)) >= BOX_Y-1) {
            ...
            // console.log("X", activeBoxX)
            // console.log("Y", activeBoxY)
            // console.log(boxArrCopy);
            // console.log(activeBoxColor);
            // console.log(boxArrCopy[activeBoxX]);
                ...
                if (time%3000 === 0) {
                    if (Math.max(...boxArr.map((e) => e.length)) >= BOX_Y-1) {
                        ...
                        for (let i=0; i<boxArr.length; i++) {
                            ...
                            // console.log("boxArrLength is:", boxArr.length)           
                            // console.log("Interval Step is:", i)               
                            const newBox = createRandomBoxColor();
                            // console.log(newBox)
                            // boxArr[i].unshift(newBox); 
                            // console.log("boxArr[i]:", boxArr[i])
                            newBoxArr[i] = [newBox,...boxArr[i]];
                            // console.log("new box array is:", newBoxArr)
